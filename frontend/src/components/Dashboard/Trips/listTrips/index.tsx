...
export function TrisDashboard() {
    const { total, completed, inProgress, scheduled, LoadingVehiclStatus } = useTripsStats();
    const { data, page, status, totalPages, destination, LoadingVehiclList, setPage, setStatus, setDestination } =
        useTripList();
    ...
    return (
        <div className="dashboardItems_container">
            <DashboardHeader>
                ...
                <GoToDriverRegister to={"/dashboard/cadastrar-viagem"}>CADASTRAR</GoToDriverRegister>
            </DashboardHeader>
